...
const PLANS = [
  {
    ...
    badge: null,
    note: 'Une formule volontairement rythmée, pour prendre le temps de vraiment connaître chaque profil.',
    items: [
      'Jusqu\'à 1 profil qualifié par semaine',
      'Profils sélectionnés selon tes critères réels',
      'Idéal pour une démarche posée et sérieuse',
  ...
  },
  {
    ...
    items: [
      'Jusqu\'à 1 profil qualifié par jour',
      'Matching basé sur compatibilité + valeurs',
  ...
  },
  {
    ...
    items: [
      'Jusqu\'à 3 profils qualifiés par jour',
      'Accès aux profils les plus compatibles en priorité',
      'Visibilité boostée auprès des profils sérieux',
      'Expérience optimisée pour accélérer les rencontres',
