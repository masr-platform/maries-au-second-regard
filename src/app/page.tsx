            ...
            {[
              {
                ...
                features: ['1 profil compatible par mois', 'Score de compatibilité détaillé', 'Chat sécurisé', 'Questionnaire IA'],
                cta: 'Commencer',
                popular: false,
              },
              {
                ...
                features: ['3 profils compatibles par mois', 'Score de compatibilité détaillé', 'Chat sécurisé prioritaire', 'Validation psychologue', 'Accompagnement mouqabala'],
                cta: 'Choisir Premium',
                popular: true,
              },
              {
                ...
                color: 'border-white/10',
                features: ['Profils illimités', 'Score détaillé + rapport complet', 'Chat prioritaire VIP', 'Suivi psychologue dédié', 'Mouqabala accompagnée', 'Support 7j/7'],
                cta: 'Choisir Ultra',
                popular: false,
              },
            ].map((plan, i) => (
