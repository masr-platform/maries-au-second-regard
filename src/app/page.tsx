            ...
            {[
              {
                ...
                features: ['1 profil qualifié / semaine', 'Profils sélectionnés selon tes critères réels', '1 mouqabala encadrée / mois (avec imam)', 'Chat sécurisé supervisé (1 pers. à la fois)', 'Score détaillé 7 dimensions', 'Support email'],
                cta: 'Commencer',
                popular: false,
              },
              {
                nom: 'Premium',
                prix: '29,90€',
                desc: 'Matching basé sur compatibilité + valeurs.',
                features: ['1 profil qualifié / jour', 'Accès prioritaire aux nouveaux profils', '3 mouqabalas encadrées / mois (avec imam)', 'Chat supervisé — plusieurs personnes', 'Analyse psychologique complète', 'Support prioritaire'],
                cta: 'Choisir Premium',
                popular: true,
              },
              {
                ...
                features: ['3 profils qualifiés / jour', 'Accès aux profils les plus compatibles en priorité', 'Visibilité boostée auprès des profils sérieux', 'Mouqabalas illimitées (avec imam)', 'Suivi psychologique personnalisé', 'Coach mariage dédié — profil mis en avant'],
                cta: 'Choisir Élite',
                popular: false,
              },
            ].map((plan, i) => (
